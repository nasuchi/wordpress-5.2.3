...
class TJ_Extras_Widget_Post_Slider extends Widget_Base {

	public function get_name() {
		return 'tj-extras-post-slider';
	}

	public function get_title() {
		return esc_html__( 'Post Slider', 'tj-extras' );
	}
	...
	public function get_script_depends() {
		return [ 'owl-carousel', 'post-slider' ];
	}

	public function get_style_depends() {
		return [ 'owl-carousel', 'owl-carousel-theme' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'post_slider',
			[
				'label' => esc_html__( 'Post Slider', 'tj-extras' ),
			]
		);
		...
		$this->add_control(
			'include_categories',
			[
				'label' 		=> esc_html__( 'Include Categories', 'tj-extras' ),
				'description' 	=> esc_html__( 'Enter the categories slugs seperated by a "comma"', 'tj-extras' ),
				'type' 			=> Controls_Manager::TEXT,
				'label_block' 	=> true,
			]
		);
		...
		$this->add_control(
			'exclude_categories',
			[
				'label' 		=> esc_html__( 'Exclude Categories', 'tj-extras' ),
				'description' 	=> esc_html__( 'Enter the categories slugs seperated by a "comma"', 'tj-extras' ),
				'type' 			=> Controls_Manager::TEXT,
				'label_block' 	=> true,
			]
		...
		$this->add_control(
			'zoom',
			[
				'label'         => esc_html__( 'Zoom Effect', 'tj-extras' ),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'enable',
				'options'       => [
	...
	protected function render() {
		...
		if ( $blog->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'posts', 'owl-carousel', 'owl-theme', 'post-slider' );
			if ( 'enable' == $zoom ) {
				$wrap_classes[] = 'zoom-effect';
			}
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				while ( $blog->have_posts() ) : $blog->the_post(); ?>
					...
					<?php get_template_part( 'partials/elementor/slider' ); ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new TJ_Extras_Widget_Post_Slider() );
