...
class TJ_Extras_Widget_Post_Carousel extends Widget_Base {

	public function get_name() {
		return 'tj-extras-post-carousel';
	}

	public function get_title() {
		return esc_html__( 'Post Carousel', 'tj-extras' );
	}
	...
	public function get_script_depends() {
		return [ 'owl-carousel', 'post-carousel' ];
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'post_carousel',
			[
				'label' => esc_html__( 'Post Carousel', 'tj-extras' ),
			]
		);
	...
	protected function render() {
		...
		if ( $blog->have_posts() ) :
			...
			// Wrapper classes
			$wrap_classes = array( 'posts', 'owl-carousel', 'owl-theme', 'post-carousel' );
			...
			<div class="<?php echo esc_attr( $wrap_classes ); ?>">
				...
				while ( $blog->have_posts() ) : $blog->the_post(); ?>
					...
					<?php get_template_part( 'partials/elementor/carousel' ); ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new TJ_Extras_Widget_Post_Carousel() );
