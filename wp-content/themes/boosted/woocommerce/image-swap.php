...
if ( ! has_post_thumbnail() ) {
	if ( function_exists( 'wc_placeholder_img_src' ) && wc_placeholder_img_src() ) {
		$placeholder = '<img src="'. wc_placeholder_img_src() .'" alt="'. __( 'Placeholder Image', 'boosted' ) .'" class="woo-entry-image-main" />';
		$placeholder = apply_filters( 'boosted_woo_placeholder_img_html', $placeholder );
		if ( $placeholder ) {
			echo $placeholder;
		}
	}
