 ...
 */
$link = apply_filters( 'boosted_num_products_link', $link );
...
<div class="wc-products-per-page">
	<span class="view-title"><?php esc_attr_e( 'Show', 'boosted' ) ?> </span>
	...
	<a class="view-all<?php if ( $num_prod == 'all' ) echo ' active'; ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php esc_attr_e( 'All', 'boosted' ) ?></a>
</div>
