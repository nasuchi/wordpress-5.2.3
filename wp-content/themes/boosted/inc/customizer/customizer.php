 ...
 */
function boosted_customize_register( $wp_customize ) {
...
add_action( 'customize_register', 'boosted_customize_register' );

/**
 * This function adds some styles to the WordPress Customizer
 */
function boosted_custom_customizer_style() { ?>
	<style>
		.customize-control {
			margin-bottom: 20px;
		}
...
add_action( 'customize_controls_print_styles', 'boosted_custom_customizer_style', 999 );

/**
 * Add the configuration.
 * This way all the fields using the 'boosted_options' ID
 * will inherit these options
 */
Kirki::add_config( 'boosted_options', array(
...
require trailingslashit( get_template_directory() ) . 'inc/customizer/options/header/top-bar.php';
