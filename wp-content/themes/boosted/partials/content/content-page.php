...
$enable_page_thumbnail = get_theme_mod( 'boosted_page_thumbnail', 0 );
$enable_page_title = get_theme_mod( 'boosted_page_title', 1 );
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php edit_post_link( esc_html__( 'Edit', 'boosted' ), '<footer class="entry-footer"><span class="edit-link">', '</span></footer>' ); ?>
